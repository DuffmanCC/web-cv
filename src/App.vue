  ...
  <div :class="{ dark: darkMode }">
    <div class="dark:bg-gray-900 text-gray-600">
      <div class="container max-w-7xl">
        <header class="p-4 lg:px-0 dark:bg-gray-900">
        ...
        <div class="dark:bg-gray-900">
          <div class="sm:flex lg:shadow-2xl">
            <aside
              class="sm:w-1/3 md:w-1/4 lg:w-1/5 p-3 sm:py-8 sm:px-2 bg-gray-300 dark:bg-gray-500 dark:text-white"
            >
              <div class="px-2 mb-6 sm:mb-12 text-center sm:text-left">
                <h1
                  class="text-4xl font-bold sm:font-normal sm:text-2xl sm:mb-2"
                >
                  Carlos Ortiz
                </h1>
              ...
              <div class="font-light text-lg px-2 mb-6 sm:mb-12">
                ...
                <div>
                  <span
                    class="cursor-pointer font-icon icon-envelope mr-2"
                  ></span>
            ...
            <main
              class="sm:w-2/3 md:w-3/4 lg:w-4/5 p-3 sm:py-8 sm:px-8 dark:bg-gray-700 dark:text-white"
            >
              <div id="profile">
              ...
              <div id="experience">
                ...
                <div v-for="(job, i) in content.experience" :key="i">
                  ...
                  <div class="mb-6 flex flex-wrap" v-if="job.skills">
                    <span
        ...
        <footer class="p-4 lg:px-0 border-b dark:bg-gray-900">
